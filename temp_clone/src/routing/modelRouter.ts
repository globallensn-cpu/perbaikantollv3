...
export const MODEL_TIERS: Record<Exclude<ModelTier, 'user_key'>, string[]> = {
  flagship: ['gemini-3.7-flash', 'gemini-3.1-pro-preview', 'gemini-3.1-pro', 'gemini-2.5-pro'],
  tier2: ['gemini-3.6-flash', 'gemini-3.5-flash', 'gemini-3-flash', 'gemini-2.5-flash', 'gemini-2.0-flash'],
  tier3: ['gemini-3.5-flash-lite', 'gemini-3.1-flash-lite', 'gemini-2.5-flash-lite', 'gemini-2.0-flash-lite'],
};
