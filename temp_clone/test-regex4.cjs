...
\`\`\`
  - **[00:20 - 00:30] Klip 3**:
    - *Aksi & Dialog/VO*: Presenter mengibaskan rambut yang tampak sehat dan berkilau. Menunjuk ke arah keranjang kuning. VO: "Jangan nunggu botak! Mumpung lagi promo, cek keranjang kuning sekarang!"
    - *Prompt AI Video*:
\`\`\`text
[Style]: Bright, commercial e-commerce product video, clean and polished aesthetic.
[Environment]: Indoor aesthetic bedroom, natural sunlight coming from window.
[Tone & Pacing]: Enthusiastic, urgent, sales-driven.
[Camera]: Medium shot, eye-level, tracking slight movement.
[Lighting]: Natural sunlight mixed with soft fill light for glowing hair.
[Actions]:
- Woman happily tossing her shiny, healthy hair, then pointing confidently downwards.
- **Dialogue**: "Jangan nunggu botak! Mumpung lagi promo, cek keranjang kuning sekarang!"
[Text Overlay]: "PROMO TERBATAS! KLIK KERANJANG KUNING"
[Background Sound]: Clear Indonesian voiceover with upbeat background music.
