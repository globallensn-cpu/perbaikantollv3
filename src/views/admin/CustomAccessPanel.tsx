...
const TOOL_OPTIONS = [
  { id: 'videoToPrompt', label: 'Ekstrak Prompt dari Video AI', icon: '🎬' },
  { id: 'tiktokDownloader', label: 'TikTok Downloader No Watermark', icon: '🎵' },
  { id: 'shopIdeas', label: 'Produk to Video AI', icon: '🛍️' },
  { id: 'contentIdeas', label: 'Replika Video Viral FYP', icon: '💡' },
...
export default function CustomAccessPanel() {
  ...
  const handleCreateAndCopyCustomAccess = (e: React.FormEvent) => {
    ...
    const newClient: ClientItem = {
      id: `cli_custom_${Date.now()}_${Math.random().toString(36).substring(2, 6)}`,
