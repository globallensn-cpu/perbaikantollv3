        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-slate-50/80 p-3.5 rounded-2xl border border-slate-200/90 space-y-2.5">
                <div className="flex items-center justify-between">
                ...
                <div className="relative flex items-center gap-1.5">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full h-11 pl-3.5 pr-20 rounded-xl bg-white border border-slate-200 focus:border-[#5b50e5] focus:ring-2 focus:ring-[#5b50e5]/20 focus:outline-none text-slate-900 text-xs placeholder:text-slate-400 transition-all shadow-2xs"
                    />
                    <button
                      type="button"
                      onClick={handlePasteShopUrl}
                      className="absolute right-1.5 top-1.5 px-2.5 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-[11px] font-bold transition-all flex items-center gap-1 cursor-pointer active:scale-95"
                      title="Tempel Link dari Clipboard"
                    >
                      <Clipboard className="w-3 h-3 text-slate-600" />
                      <span>Tempel</span>
                    </button>
                  </div>
                  ...
                  <button
                    type="button"
                    onClick={() => handleFetchShopProduct()}
                    disabled={isFetchingShop || !tiktokShopUrl.trim()}
                    className="h-11 px-3.5 bg-[#5b50e5] hover:bg-[#4b40d5] disabled:opacity-50 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shrink-0 transition-all cursor-pointer shadow-sm active:scale-95"
                    title="Ambil informasi produk TikTok Shop"
                  >
                    {isFetchingShop ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
                ...
                {shopProductInfo && (
                  <motion.div
                    ...
                    className="p-2.5 bg-emerald-50/90 border border-emerald-200 rounded-xl flex items-center justify-between gap-3 text-xs"
                  >
                ...
                <p className="text-[11px] text-slate-500">
                  Tempelkan link produk TikTok Shop / Tokopedia untuk otomatis menghasilkan ide replika video viral khusus produk ini.
                </p>
              </div>
            </div>
          </div>
